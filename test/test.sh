...
for input in $inputs do
	...
	(time $ref_simple -i sampledata/${input} -o /tmp/ref_${input}) 2> /tmp/ref_${input}_time
	(time $improved_simple -i sampledata/${input} -o /tmp/improved_${input}) 2> /tmp/improved_${input}_time
